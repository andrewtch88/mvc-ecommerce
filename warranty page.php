...
<div class="textbox">
	...
	<ul style="list-style:none;content:bullet;color:white">
		...
		<br><li class="text">Pack the hardware in its original box, bubble wrap it and place it in another box, for full rig PC please put it back with the original box with its styrofoam, do remove your GPU if its too heavy; Then we will send GD Express to pickup the parcel ( We DO NOT cover any physical damages caused from shipping; As such, the customer will take sole responsibility for any physical damage from bad packaging ).</li>
		<br><li class="text">Shipping and service charges may be applicable IF hardware tested non faulty and / or caused by hardware not purchased from OG Tech PC, the final decision lies with the staffs of OG Tech PC.</li>
